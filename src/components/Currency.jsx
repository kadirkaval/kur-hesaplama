...
let API_KEY="fca_live_v20fHjtfd2vT8OjsNe5eycNdchgWUxfknN7aqOhX";
...
const exchange = async()=>{
 const promise = await axios.get(`${BASE_URL}?apikey=${API_KEY}&base_currency=${fromCurrency}`)
  ...
  return (
    <div className='border w-2/4 mx-auto rounded-lg'>
        ...
        <div className='text-center'>
          <button 
          onClick={exchange}
          className='bg-blue-500 text-white font-semibold text-2xl p-2 rounded border border-gray-300 m-2 hover:bg-blue-700'>Hesapla</button>
        </div>
    </div>
  )
}
